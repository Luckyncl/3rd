...
//    Sophisticated multi-channel input hardware support.
    ...
    // Set the audio unit's input callback  设置音频单元的音频回调
    // Setup render callback struct             开启渲染结构体
