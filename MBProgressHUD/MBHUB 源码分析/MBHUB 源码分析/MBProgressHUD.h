 ...
 * - MBProgressHUDModeIndeterminate - shows a UIActivityIndicatorView  // 菊花
 * - MBProgressHUDModeDeterminate - shows a custom round progress indicator     圆形进度
 * - MBProgressHUDModeAnnularDeterminate - shows a custom annular progress indicator    自定义进度条
