...
@property (nonatomic, readonly) NSUInteger expectedLength;           // 总长度
@property (nonatomic, readonly) NSUInteger receivedLength;          // 接收长度
@property (nonatomic, readonly) NSUInteger downloadSpeed;           // 下载速度
